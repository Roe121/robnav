...
if("TRUE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/ubuntu/workspace/src/detection)
  set(detection_DEVEL_PREFIX /home/ubuntu/workspace/devel)
  ...
  set(detection_INSTALL_PREFIX /home/ubuntu/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/workspace/src/detection/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT detection_NUM_DUMMY_TARGETS)
      set(detection_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::detection::wrapped-linker-option${detection_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR detection_NUM_DUMMY_TARGETS "${detection_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::detection::wrapped-linker-option${detection_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND detection_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(detection_EXPORTED_TARGETS ${${detection_dep}_EXPORTED_TARGETS})
endforeach()
